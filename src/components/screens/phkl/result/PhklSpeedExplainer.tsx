...
export function PhklSpeedExplainer() {
  ...
  return (
    <section className="bg-gradient-to-b from-[#fff7f2] via-[#ffeddb] to-[#fff8f2] px-6 pb-12 pt-6">
      <Reveal className="flex justify-center">
        <BrainHero className="h-[150px] w-auto" />
      </Reveal>

      <Reveal>
        <h2 className="mt-5 text-balance text-[clamp(2rem,9.2vw,2.375rem)] font-extrabold leading-[1.2] tracking-[-0.02em] text-charcoal">
