...
/** Screen 5 — ~5–8s of suspense, cycling credibility crumbs. */
export function AnalysingScreen({ onDone }: AnalysingScreenProps) {
  const crumbs = COPY.screens.analysing.crumbs;
    ...
    <ScreenShell>
      <div className="flex min-h-[80vh] flex-col items-center justify-center text-center">
        ...
        <h1 className="mt-8 font-display text-2xl font-bold text-charcoal">
          {COPY.screens.analysing.heading}
        </h1>
        <p
          key={index}
