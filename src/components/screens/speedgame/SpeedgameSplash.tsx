...
interface SpeedgameSplashProps {
  /**
...
/**
 * Speed Game landing (independent duplicate of Event3Splash, Figma "01
 * Landing"): daylight cream backdrop with the animated yellow pill lines,
 * gradient hero words, the brain hero, name + email capture, and the ember
 * CTA. Vertical rhythm is expressed in dvh so it holds the designed
 * proportions on any phone - a height breakpoint would miss real mobile
 * viewports (~700px once the browser chrome is showing).
 */
export function SpeedgameSplash({ onSubmit }: SpeedgameSplashProps) {
  const c = COPY.screens.speedgame.splash;
