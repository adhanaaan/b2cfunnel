...
/**
 * The one call to action on the Siloam summit's report, pinned to the bottom
 * of the screen for the whole scroll - the same bar /phkl ships, pointed at
 * this event's close.
 *
...
export function SiloamStickyCta() {
  const c = useCopy().screens.siloam.report.sticky;
