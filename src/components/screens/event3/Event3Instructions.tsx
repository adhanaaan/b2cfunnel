...
interface Event3InstructionsProps {
...
/**
 * Event3 instructions (Figma "02 challenge 1"): instead of written rules,
 * a self-playing demo loop shows a real round in real time. The player can
