...
export function ScreenShell({ children, wide = false }: ScreenShellProps) {
  return (
    <main className="relative flex min-h-screen flex-col items-center px-4 py-8 sm:py-12">
      ...
      <div
        aria-hidden
        className="pointer-events-none fixed inset-0 -z-10 overflow-hidden bg-gradient-to-b from-[#fff4ee] via-surface to-[#fbe7de]"
      >
