...
interface ScorePayload {
   ...
   * ROTARY_SOURCE, NTU_HOMECOMING_SOURCE, IHHSEA_SOURCE, IHH_SOURCE,
   * PHKL_SOURCE, TWENTY_TWO_GRAMS_SOURCE or GENERAL_SOURCE.
      ...
      : payload.source === ROTARY_SOURCE
        ...
        : payload.source === NTU_HOMECOMING_SOURCE
          ...
          : payload.source === IHHSEA_SOURCE
            ? IHHSEA_PAUSED
            : payload.source === IHH_SOURCE
              ? IHH_PAUSED
              : payload.source === PHKL_SOURCE
                ? PHKL_PAUSED
                : payload.source === TWENTY_TWO_GRAMS_SOURCE
                  ? TWENTY_TWO_GRAMS_PAUSED
