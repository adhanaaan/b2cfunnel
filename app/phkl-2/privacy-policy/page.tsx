...
/**
 * /phkl-2/privacy-policy - the policy behind the "Privacy Policy" link in the
 * /phkl-2 landing's required consent row.
 *
 ...
 */
export default function Phkl2PrivacyPolicyPage() {
  return (
